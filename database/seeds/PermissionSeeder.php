...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //vocations
        $vocations_module = Module::Create([
            'name' => 'Vocation'
        ]);
        ...
        Permission::insert(
            [
                [
                    'module_id' => $vocations_module['id'],
                    'key' => 'view_vocations',
                    'name' => 'View'
                ],
                [
                    'module_id' => $vocations_module['id'],
                    'key' => 'create_vocations',
                    'name' => 'Create'
                ],
                [
                    'module_id' => $vocations_module['id'],
        ...
        //violations
        $violations_module = Module::Create([
            'name' => 'Violations'
        ]);
        ...
        Permission::insert(
            [
                [
                    'module_id' => $violations_module['id'],
                    'key' => 'view_violations',
                    'name' => 'View'
                ],
                [
                    'module_id' => $violations_module['id'],
                    'key' => 'create_violations',
                    'name' => 'Create'
                ],
                [
                    'module_id' => $violations_module['id'],
        ...
        //attendance
        $attendance_module = Module::Create([
            'name' => 'Attendance'
        ]);
        ...
        Permission::insert(
            [
                [
                    'module_id' => $attendance_module['id'],
                    'key' => 'view_attendance',
                    'name' => 'View'
                ],
                [
        ...
        Permission::insert(
            [
                ...
                [
                    'module_id' => $groups_module['id'],
                    'key' => 'view_retrieve_group',
                    'name' => 'View Retrieved'
                ],
            ]
        );

        // add show without sgin medical report
        Permission::insert(
            [
                [
                    'module_id' => $medical_reports_module['id'],
                    'key' => 'review_medical_report',
                    'name' => 'review'
                ],
                [
                    'module_id' => $medical_reports_module['id'],
                    'key' => 'show_without_sgin_medical_report',
                    'name' => 'Show Without Sgin'
                ]
            ]
        );
        ...
        Permission::insert(
            [
                ...
                [
                    'module_id' => $safe['id'],
                    'key' => 'accept_export_safe',
                    'name' => 'Accept Export'
                ],
                [
                    'module_id' => $safe['id'],
                    'key' => 'refuse_export_safe',
                    'name' => 'Refuse Export'
                ],
                [
                    'module_id' => $safe['id'],
        ...
        Permission::insert(
            [
                [
                    'module_id' => $reports_module['id'],
                    'key' => 'view_contract_report',
                    'name' => 'View Contract Report'
                ]
            ]
        );
        Permission::insert(
        ...
        Permission::insert(
            [
                [
                    'module_id' => $groups_module['id'],
                    'key' => 'allow_print_with_due',
                    'name' => 'Show Reports If Not Paid'
                ]
            ]
        );
        ...
        $values = Module::Create([
            'name' => 'values Opration'
        ]);
