...
Route::group(['prefix'=>'ajax','as'=>'ajax.','middleware'=>'Ajax'],function(){
    ...
    Route::get('patient_exist' , 'AjaxController@patient_exist')->name('patient_exist')->middleware('Admin');
    Route::get('doctor_exist' , 'AjaxController@docter_exist')->name('doctor_exist');
    //get patient
    Route::get('get_patient','AjaxController@get_patient')->name('get_patient'); 

    Route::get('get_prefix' , 'AjaxController@getPrefix')->name('get_prefix');
    //create patient
    ...
    Route::get('get_catgory' , 'AjaxController@getCategory')->name('get_cat');
    //get unread messages
    ...
    Route::get('get_branches','AjaxController@get_branches')->name('get_branches');
    ...
    //get income chart
    Route::get('get_income_chart2','AjaxController@get_income_chart2')->name('get_income_chart2')->middleware('Admin');
    ...
    //select2 timezones
    Route::get('get_tax_select2','AjaxController@get_tax_select2')->name('get_tax_select2')->middleware('Admin');
    ...
    Route::get('get_invoice_offers' , 'AjaxController@get_invoice_offers')->name('get_invoice_offers');
    Route::get('get_invoice_offer' , 'AjaxController@get_invoice_offer')->name('get_invoice_offer');

    //get invoice tests
    Route::get('get_invoice_rays','AjaxController@get_invoice_rays')->name('get_invoice_rays')->middleware('Admin');
    ROute::get('get_deduction' , 'Admin\DeductionsController@get')->name('get_deduction');
    //get invoice ray
    ...
    Route::get('get_invoice_extraServices' , 'AjaxController@get_invoice_extraServices')->name('get_invoice_extraServices');
    Route::get('get_invoice_extraService' , 'AjaxController@get_invoice_extraService')->name('get_invoice_extraService');
    ...
    // get get Branches Report
    Route::get('get_branches_report','AjaxController@get_branches_report')->name('get_branches_report')->middleware('Admin');

    // get get_rays_categories
    Route::post('printer','AjaxController@printer')->name('printer')->middleware('Admin');
    
    // get get_rays_categories
    Route::get('get_sub_contract','AjaxController@get_sub_contract')->name('get_sub_contract')->middleware('Admin'); 
    
    // get get_rays_categories
    Route::get('get_rays','AjaxController@get_rays')->name('get_rays')->middleware('Admin'); 

    // get get_rays_categories
    Route::get('get_request_employee','AjaxController@get_request_employee')->name('get_request_employee')->middleware('Admin'); 
    
    Route::get('get_new_booking','AjaxController@get_new_booking')->name('get_new_booking')->middleware('Admin'); 
    Route::post('set_test_receive','AjaxController@set_test_receive')->name('set_test_receive')->middleware('Admin'); 
    Route::get('get_crystals_data','AjaxController@get_crystals_data')->name('get_crystals_data')->middleware('Admin'); 
