...
Route::group(['prefix'=>'admin','as'=>'admin.','namespace'=>'Admin','middleware'=>['Admin','Branch']],function(){
    ...
    Route::get('new-invoice' , function(){
        return view('admin.groups.Reception.invoices.create');
    });

      
      // notification
    Route::resource('notifications','NotificationController');
    Route::get('notification/get_notifications','NotificationController@ajax')->name('get_notifications');
    Route::post('notifications/bulk/delete','NotificationController@bulk_delete')->name('notifications.bulk_delete');
        //change branch
    ...
    Route::resource('current_offers', 'CurrentOffersController');
    Route::post('categories/bulk/delete','CategoriesController@bulk_delete')->name('categories.bulk_delete');
    Route::get('categories_export','CategoriesController@export')->name('categories.export');
    Route::post('categories_import','CategoriesController@import')->name('categories.import');

    

    Route::get('attendance_export' , 'EmployeesController@export')->name('attendance.export');

    Route::post('attendance_import' , 'EmployeesController@import')->name('attendance.import');
    Route::get('attendance_download_template' , 'EmployeesController@EmployeesController')->name('attendance.download_temp');
    ...
    Route::get('tests_export/{id?}','TestsController@export')->name('tests.export');
    Route::post('tests_import','TestsController@import')->name('tests.import');
    Route::post('setting_test/{id}','TestsController@settingTest')->name('tests.setting_test');
    ...
    Route::get('delete-group-image' , 'GroupsController@deleteGroupImage')->name('delete-group-image');
    //cultures
    Route::resource('cultures','CulturesController');

    Route::resource('extraService', 'ExtraServicesController');
    Route::get('get_extraServices','ExtraServicesController@ajax')->name('get_extraServices');

    Route::get('offers','CurrentOffersController@ajax')->name('offers');
    Route::get('get_incentives','IncentiveController@ajax')->name('get_incentives');


    Route::get('get_deductions' , 'DeductionsController@ajax')->name('get_deductions');
    ...
    Route::get('/paid_due/{group_id}','GroupsController@paidDue')->name('paid_due');
    Route::post('calce/send','GroupsController@sendCalculator')->name('groups.send_calc');
    ...
    Route::post('groups/print_barcode_file/{group_id}','GroupsController@print_barcode_file')->name('groups.print_barcode_file');
    ...
    Route::post('medical_reports_ajax/{id}','MedicalReportsController@submit_ajax')->name('medical_reports.ajax');
    ...
    Route::get('medical_reports/print_report_with_header_action/{id}','MedicalReportsController@print_report_with_header_action')->name('medical_reports.print_report_with_header_action');
    ...
    Route::get('medical_reports/print_report_without_header_action/{id}','MedicalReportsController@print_report_without_header_action')->name('medical_reports.print_report_without_header_action');
    ...
    Route::post('medical_report/add_comment','MedicalReportsController@addComment')->name('medical_report.add_comment');
    ...
    Route::post('medical_report/edit_setting_test/{id}','MedicalReportsController@SettingTest')->name('medical_report.setting_test');
    Route::get('medical_report/get_whats_app_url/{id}','MedicalReportsController@getWhatsAppUrl')->name('medical_report.get_whats_app_url');
    ...
    //tests price list
    Route::get('prices/rays','PricesController@rays')->name('prices.rays');
    Route::post('prices/rays','PricesController@rays_submit')->name('prices.rays_submit');
    Route::get('rays_prices_export','PricesController@rays_prices_export')->name('prices.rays_prices_export');
    Route::post('rays_prices_import','PricesController@rays_prices_import')->name('prices.rays_prices_import');
    ...
    Route::get('download_template/{id}','ContractsController@downloadTemplate')->name('contract.download_template');
    ...
    Route::group(['prefix'=>'settings','as'=>'settings.'],function(){
        ...
        Route::post('invoices' , 'SettingsController@invoices_submit')->name('invoices_submit');
        ...
        Route::post('accounting','SettingsController@accounting_submit')->name('accounting');
        Route::post('portal' , 'SettingsController@portal_submit')->name('portal');
    });
    ...
    Route::group(['prefix'=>'inventory','as'=>'inventory.','namespace'=>'Inventory'],function(){
        ...
        Route::post('product_import','ProductsController@import')->name('product.import');
        Route::get('product_export','ProductsController@export')->name('product.export');
    ...
    Route::group(['prefix'=>'reports','as'=>'reports.'],function(){
        ...
        Route::get('getAccountingGroups','ReportsController@getAccountingGroups')->name('getAccountingGroups');
        Route::get('getAccountingPayments','ReportsController@getAccountingPayments')->name('getAccountingPayments');
        Route::get('getAccountingExpenses','ReportsController@getAccountingExpenses')->name('getAccountingExpenses');
        Route::get('getAccountingPayments','ReportsController@getAccountingPayments')->name('getAccountingPayments');
    ...
    Route::group(['prefix'=>'reports','as'=>'reports.'],function(){
        ...
        Route::get('safe','ReportsDetialsController@safe')->name('safe');
    ...
    Route::get('salary-details' , 'EmployeesController@salaryDeatils')->name('salary-details');

    Route::get('get_employees','EmployeesController@ajax')->name('get_employees');
    Route::get('get_shifts','ShiftController@ajax')->name('get_shifts');
    Route::get('shiftdownloadpdf/{id}' , 'ShiftController@downloadpdf')->name('shiftdownloadpdf');
    ...
    Route::post('salary_details' , 'EmployeesController@chechInOut')->name('checkOut');
    //violations
    ...
    Route::post('vault/bulk/delete','CashVaultController@bulk_delete')->name('vault.bulk_delete');
    ...
    Route::get('get_branches_custody','BranchCustodyController@ajax');
    Route::get('transfer_to_bank','BranchCustodyController@transferToBank')->name('transfer_to_bank');
    Route::get('convertBranchSafeToVisa/{id}','BranchCustodyController@convertBranchSafeToVisa')->name('convertBranchSafeToVisa');
    Route::get('convertMainSafeToVisa','BranchCustodyController@convertMainSafeToVisa')->name('convertMainSafeToVisa');
    Route::get('convertBankToVisa','BranchCustodyController@convertBankToVisa')->name('convertBankToVisa');
   ...
   Route::post('send_test_submit','MedicalReportsController@sendToLabSubmit')->name('send_test_submit');
    ...
    // safe pending
    Route::resource('safe_transfer','SafeTrasfersController');
    Route::get('get_safe_transfer','SafeTrasfersController@ajax');
    Route::get('get_main_transfer','SafeTrasfersController@get_main_transfer');
    Route::get('safe_transfer/accept/{id}','SafeTrasfersController@accept')->name('safe_transfer.accept');
    Route::get('safe_transfer/refuse/{id}','SafeTrasfersController@refuse')->name('safe_transfer.refuse');
    Route::get('safe_transfer/export/{id}','SafeTrasfersController@export')->name('safe_transfer.export');
    Route::get('safe_transfer/acceptExport/{id}','SafeTrasfersController@acceptExport')->name('safe_transfer.acceptExport');
    Route::get('safe_transfer/refuseExport/{id}','SafeTrasfersController@refuseExport')->name('safe_transfer.refuseExport');
    Route::post('safe_transfer/bulk/delete','SafeTrasfersController@bulk_delete');
    Route::post('safe_transfer/accept_all','SafeTrasfersController@accept_all');

    //safe refused

    Route::get('safe_transfer_refused','SafeRefusedController@index');
    Route::get('get_safe_transfer_refused','SafeRefusedController@ajax');


    Route::get('upload_data_online/{id}','UploadDataOnline@index')->name('upload_data_online');

    Route::resource('whatsapp','SendWhatsAppController');


    // Auto Comment Routes
    Route::get('get_auto_comments' , 'AutoCommentController@ajax');

    Route::group(['as'=>'autoComments.' , 'prefix'=>'auto_comment'],function(){
         Route::get('get_new_test_select', 'AutoCommentController@get_new_test_select')->name('get_new_test_select');
        Route::get('getcomments/{test_id}', 'AutoCommentController@index')->name('index');
        Route::get('create', 'AutoCommentController@create')->name('create');
        Route::post('store', 'AutoCommentController@store')->name('store');
        Route::get('edit/{id}', 'AutoCommentController@edit')->name('edit');
        Route::get('show/{id}', 'AutoCommentController@show')->name('show');
        Route::put('update/{id}', 'AutoCommentController@update')->name('update');
        Route::delete('destroy/{id}/{com_id}', 'AutoCommentController@destroy')->name('destroy');
        Route::post('getcomments/bulk/delete', 'AutoCommentController@bulk_delete')->name('getcomments.bulk_delete');


        Route::post('add_comments', 'AutoCommentController@addComments')->name('add_comment');
        Route::put('update_single_comment/{id}', 'AutoCommentController@update_single_comment')->name('update_single_comment');


    });
    // Route::resource('autoComments' , 'AutoCommentController');
    // End Auto Commnts Routes

    Route::group(['as'=>'portal.' , 'prefix'=>'portal'],function(){
        Route::get('portal-tests' , 'PortalController@tests')->name('tests-portal');
        Route::get('culturies' , 'PortalController@culturies')->name('culturies');
        Route::get('packages' , 'PortalController@packages')->name('packages');
        Route::get('rays_portal' , 'PortalController@rays')->name('rays_portal');
        // Route::post('add_comments' , 'AutoCommentController@addComments')->name('add_comment');
    });
//admin.invoice.index
    Route::group(['as'=>'invoice.'  , 'namespace'=>'Portal'] , function(){
        Route::get('index' , 'InvoiceController@sentInvoices')->name('index');
        Route::get('sendToportal/{id}' , 'InvoiceController@sendInvoice')->name('sendInvoice');
        
    });
    Route::post('/test' , 'TestsController@addTestToPortal');
    Route::post('/culture' , 'CulturesController@addCultureToPortal');
    Route::post('/package' , 'PackagesController@addPackageToPortal');
    Route::post('/rays_portal' , 'RaysController@addRaysToPortal');
