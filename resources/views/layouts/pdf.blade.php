...
<body>
                        ...
                        <tbody>
                            <tr>
                                <td width="15%" align="right" style="border: 1px solid white;">
                                    <img src="https://nbdlab.stop4labs.com/img/logo-new.png" width="100px" />
                                </td>
  ...
  <table style="width: 100%;">
              ...
              <tr>
                 ...
                 <td width="25%">
                    <img src="data:image/png;base64,{{ DNS1D::getBarcodePNG($group['barcode'], $barcode_settings['type'][session('branch_id')]) }}" alt="barcode"></td>
                 ...
                 @endif
                 @if (isset($group['patient']) && $reports_settings['show_qrcode'])
                        <td rowspan="4">
             ...
             <tr>
               ...
               @endif</td>
                ...
                <tr>
                 <td style="background-color:#EBECF0;">Reffered by: <span style="font-weight: bold;">Dr.</span></td>
                 <td width="25%">
              ...
              <tr>
                 <td style="background-color:#EBECF0;">D.Reporting:</td>
                  @if($diff)
                      <td width="25%">{{ $group['updated_at'] }}</td>
                  @else
              ...
              <tr>
                 ...
                 @endif
                  ...
                  <!--<td style="width:25%;">-->
                  <!--    @if($group['is_out'] == 1)-->
                  <!--        <bdi> Outside </bdi> {{ $info['name'] }}-->
                  <!--    @else-->
                  <!--        <bdi> Inside </bdi> {{ $info['name'] }}-->
                  <!--    @endif-->
                  <!--</td>-->
...
<div class="signature">
                                ...
                                <!--     <p class="signature" style="padding-right:50px;padding-bottom:110px !important;">-->
                                <!--            Signature-->
                                <!--            </p>-->
                                <!--@endif-->
