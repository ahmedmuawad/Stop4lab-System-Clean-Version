        ...
        <htmlpageheader name="page-header">
            ...
            @if (isset($group['patient']))
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td style="background-color:#EBECF0;">Reffered by: <span style="font-weight: bold;">Dr.</span>
                        </td>
                        <td width="25%">
...
@endif-->
                    <!--@endif-->
                    @if (isset($group['signed_by']))
                        <p
                            style="color:black; text-align: left; padding-left: 150px; text-decoration:bold; padding-bottom:110px !important;">
                            Report at {{ $group->review_date }} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sign By
