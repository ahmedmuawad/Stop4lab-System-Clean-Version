...
@section('content')
    ...
    @foreach ($branchSummary as $branch)
            ...
            <table class="table" width="100%">
                ...
                <tbody>
                    @if ($branch)
                        ...
                        <tr>
                            <td>{{ __('Invoices Total Amount ') }}</td>
                            <td>{{ $branch->subtotal }} </td>
                        </tr>
                        <tr>
                            <td>{{ __('Sales Value') }} </td>
                            <td>{{ $branch->discount }} </td>
                        </tr>
                        <tr>
                            <td>{{ __('Total Invoices after sale') }}</td>
                            <td>{{ $branch->total }} </td>
                        </tr>
                        <tr>
                            <td>{{ __('Total Paid') }} </td>
                            <td>{{ $branch->totalPaid }} </td>
                        </tr>

                        <tr>
                            <td>{{ __('Custody Of Branch') }}</td>
                            <td>{{ $branch->branchCustody }} </td>
                        </tr>
                        <tr>
                            <td>{{ __('Total After Custody') }} </td>
                            <td>{{ $branch->custody }} </td>
                        </tr>
                        ...
                        @if (isset(setting('account')['expenses_type']) && setting('account')['expenses_type'] == "cach")    
                            <tr>
                                <td>{{ __('Benfit') }} </td>
                                <td>{{ $branch->totalPaid - $branch->expenses }} </td>
                            </tr>
                        @endif
                    @endif
                </tbody>
        ...
        <table class="table table-bordered" width="100%">
            ...
            <tbody>
            @if (count($branch->brnachGroups ) == 0)
                <tr>
