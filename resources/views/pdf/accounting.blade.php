...
@section('content')
    <style>
        ...
        <table class="table table-bordered" width="100%">
            ...
            <tbody>
            <tr>
                <th width="100px" align="left">{{ __('Total After Discount') }}:</th>
                <td>{{ formated_price($data['total']) }}</td>
            </tr>
            <tr>
                <th width="100px" align="left">{{ __('Discount Presentage') }}:</th>
                <td>{{ formated_price($data['discount_presentage']) }}</td>
            </tr>
            <tr>
                <th width="100px" align="left">{{ __('Total') }}:</th>
                <td>{{ formated_price($data['total_before_discount']) }}</td>
            </tr>
            <tr>
        ...
        {{-- branch summary --}}
            ...
            <table class="table table-bordered" width="100%">
                <thead>
                    ...
                    <tr>
                        <th width="100px" align="left">{{ __('Paid') }}:</th>
                        <td>{{ formated_price($branch->totalPaid) }}</td>
                    </tr>
                    <tr>
                        <th width="100px" align="left">{{ __('Due') }}:</th>
