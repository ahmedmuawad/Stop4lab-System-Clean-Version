                    ...
                    @if (count($category['tests']) > 1)
                        <table class="ttable">
                            <thead class="testtable">
                                <tr>
                                    <td class="theadtest" text-align="left">Test </td>
                                    <td class="theadtest">Result</td>
                                    <td class="theadtest">Unit</td>

                                    @if (session('report_design') == '1')
                                        <td class="theadtest" width="15%">Status</td>
                                    @endif
                                    <td class="theadtest">Normal Range</td>
                            ...
                            <tbody>
                                        ...
                                        @if (isset($result['component']))
                                            ...
                                            @else
                                                <tr>
                                                    ...
                                                    @if (session('report_design') == '1')
                                                        <td class="tdtest">{{ $result['status'] }} @if ($result['status'] == 'High' || $result['status'] == 'Critical high')
                                                                <span>&#8593;</span>
                                ...
                                @if (isset($test['comment']))
                                    <br>
                                    <tr class="comment" width="100%">
                                                        <td width="12px" nowrap="nowrap"><b>Comment:</b></td>
                                                        <td class="commentb" colspan="3">
                                                            {!! str_replace("\n", '<br />', $test['comment']) !!}
                                                        </td>
                                    </tr>
                                @endif
                                                    ...
                                                    @if (isset($result['component']))
                                                        ...
                                                        @else
                                                            <tr>
                                                                ...
                                                                <td
                                                                    @if ($result['status'] != 'Normal' && $result['status'] != null) class="tdtest_status" @endif>
                                                                    {{ $result['result'] }} </td>
