...
<style>
    ...
    <table class="table table-bordered" width="100%">
        ...
        <tr>
            ...
            <td>{{formated_price($data['groups']->sum('paid'))}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{count($data['groups'])}}</td>
        </tr>
        @if (isset($data['doctor_commission']))
            
            <tr>
                <th width="100px" align="left">{{__('Doctor Commission %')}}:</th>
                <td>{{formated_price($data['doctor_commission'])}}</td>
            </tr>
            <tr>
                <th width="100px" align="left">{{__('Doctor Commission  Total')}}:</th>
                <td>{{formated_price($data['doctor_total'])}}</td>
            </tr>
            <tr>
                <th width="100px" align="left">{{__('Count Invoices')}}:</th>
                <td>{{count($data['groups'])}}</td>
