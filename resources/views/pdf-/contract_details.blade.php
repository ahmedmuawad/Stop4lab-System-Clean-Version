      ...
      <table class="table table-bordered" width="100%">
        <thead>
            ...
            <tr>
                ...
                <td>{{ $contractInvoice->data }}</td>
            </tr>
            <tr>
                <th width="100px" align="left">{{ __('Total') }}:</th>
                <td>{{ formated_price($contractInvoice->sub_total) }}</td>
            </tr>
            <tr>
                <th width="100px" align="left">{{ __('Due') }}:</th>
                <td>{{ formated_price($contractInvoice->due) }}</td>
            </tr>
            <tr>
                <th width="100px" align="left">{{ __('Delayed Money') }}:</th>
                <td>{{ formated_price($contractInvoice->delayed_money) }}</td>
            </tr>
        </table>
