...
@if (isset($reports_settings['report_paid_stauts']) && $reports_settings['report_paid_stauts'] == false && $group['due'] > 0 )
                        ...
                        @if (count($category['tests']) > 1)
                            <table class="ttable">
                                <thead style="background-color: #efefef !important">
                                    <tr>
                                        <th style="background-color: #320cda !important" width="30%" text-align="left">Test </th>
                                        <th style="background-color: #efefef !important" width="20%">Result</th>
                                        <th style="background-color: #efefef !important" width="10%">Unit</th>
                                    ...
                                    @elseif($test['test']['id'] == 3045)
                                        <table class="tablesemen">
                                                ...
                                                <tbody>
                                                    @foreach ($test['results'] as $result)
                                                        @if (isset($result['component']))
                                                            ...
                                                            <tr>
                                                                <td colspan="4"><b>Sperm quantification and Motility:-</b></td>
                                                            </tr>
                                                            ...
                                                            @else
                                                                <tr style="border:0px solid #b3adad;">
                                                                    ...
                                                                    <td @if ($result['status'] != 'Normal' && $result['status'] != null) class="tdtest_status" @endif align="center">{{ $result['component']['unit'] }} </td>
                                                ...
                                                @if (isset($result['component']))
                                                    ...
                                                    <td class="borderd" width="80px"> {{ $result['result'] }}
                                                        ...
                                                        @elseif($result['status'] == 'Low' || $result['status'] == 'Critical low')
                                                            <span>&#8595;</span>
                                                        @endif</td>
                                                    <td class="borderd" width="20px"@if ($result['status'] != 'Normal' && $result['status'] != null) class="tdtest_status" @endif align="center">{{ $result['component']['unit'] }} </td>
                                            ...
                                            <table class="table_inside">
                                                <thead>
                                                    <tr>
                                                        <th colspan="2" width="30%" align="left"><b>Type of Abnormality:-</b></th>
                                                    ...
                                                    <tbody>
                                                        @foreach ($test['results'] as $result)
                                                                ...
                                                                <td class="borderd"> {{ $result['result'] }}
                                                                    ...
                                                                    <td class="borderd"@if ($result['status'] != 'Normal' && $result['status'] != null) class="tdtest_status" @endif align="center">{{ $result['component']['unit'] }} </td>
                                                                    <td class="borderd"> {!! $result['comment'] !!}</td>                                                            </tr>
                                    ...
                                    <table class="ttable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                @if (\Str::slug($result['component']['name']) == "hemoglobin-hb" ||
                    ...
                    @if (count($category['cultures']))
                        @foreach ($category['cultures'] as $culture)
                            ...
                            <br>
                                ...
                                <tbody>
                                    <tr>
                                        <td width="33%"><p style="text-decoration: underline;">High Senestive Antimicrobial</p></td>
                                        <td width="33%"><p style="text-decoration: underline;">Moderate Senestive Antimicrobial</p></td>
                                        <td width="34%"><p style="text-decoration: underline;">Resistant Senestive Antimicrobial</p></td>
                                    </tr>
                                    <tr>
                                        ...
                                        - {{ $antibiotic['antibiotic']['name'] }}@endif
                                        </ul>
                                        @endforeach
                                        </td>
                                        {{--  <td align="left">
