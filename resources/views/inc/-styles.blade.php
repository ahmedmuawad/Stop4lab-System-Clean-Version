...
<link href="{{asset('new_design/assets/css/components/tabs-accordian/custom-accordions.css')}}" rel="stylesheet" type="text/css" />
<!-- BEGIN GLOBAL MANDATORY STYLES -->
<link href="https://fonts.googleapis.com/css?family=Tajawal:400,600,700" rel="stylesheet">
<link href="{{asset('new_design/assets/css/apps/notes.css')}}" rel="stylesheet" type="text/css"/>
...
<link href="https://fonts.googleapis.com/css?family=Tajawal:400,600,700" rel="stylesheet">
    ...
    <link rel="stylesheet" href="{{url('plugins/fontawesome-free/css/all.min.css')}}">
    <link rel="stylesheet" href="{{url('new_design/assets-light-rtl/css/select2.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('css/toastr.min.css')}}">
    <link rel="stylesheet" href="{{url('plugins/flatpickr/flatpickr.min.css')}}">
    <link rel="stylesheet" href="{{url('plugins/daterangepicker/daterangepicker.css')}}">
