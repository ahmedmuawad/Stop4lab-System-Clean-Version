...
<script src="{{asset('new_design/assets/js/loader.js')}}"></script>
...
@if(auth()->guard('admin')->check())
  <script>
    ...
    var can_edit_vocations=@can('edit_vocations') true @else false @endif;
...
<script>
  ...
  toastr_warning(trans("{{Session::get('warning')}}"));
  @endif
</script>
<!-- \Flash messages -->
