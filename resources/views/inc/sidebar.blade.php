        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="Reception" data-parent="#accordionExample">
                            ...
                            @if (setting('portal') != null)
                                <li>
                                    <a href="{{ route('admin.invoice.index') }}"> {{ __('Portal Invoice') }} </a>
                                </li>
                            @endif
                            ...
                            @can('create_group')
                                ...
                                <li>
                                    <a href="{{ route('admin.knows.index') }}"> {{ __('Know Us') }} </a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                        ...
                        <ul class="collapse submenu list-unstyled" id="Test-Culutre" data-parent="#accordionExample">
                            ...
                            @if ($branch_rays == 0)
                                ...
                                @can('view_test')
                                    ...
                                    <li>
                                        <a href="{{ route('admin.sample_types.index') }}"> {{ __('Sample Types') }} </a>
                                    </li>
                                @endcan
                            ...
                            @can('view_culture')
                                <li>
                                    <a href="{{ route('admin.extraService.index') }}"> {{ __('extraService') }} </a>
                                </li>
                            @endcan
                            @can('view_package')
                                <li>
                                    <a href="{{ route('admin.current_offers.index') }}"> {{ __('Offers') }} </a>
                                </li>
                            @endcan
                ...
                @if (setting('portal') != null)
                    @canany(['view_category', 'view_test', 'view_culture', 'view_culture_option', 'view_antibiotic'])
                        <li class="menu">
                            <a href="#Test-Culutre-Portal" data-toggle="collapse" aria-expanded="true"
                                ...
                                <div class="">
                                    ...
                                    <span>{{ __('Tests & Cultures Codes') }} </span>
                                </div>
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            ...
                            <ul class="collapse submenu list-unstyled" id="Test-Culutre-Portal"
                                data-parent="#accordionExample">

                                @can('view_test')
                                    <li>
                                        <a href="{{ route('admin.portal.tests-portal') }}"> {{ __('Tests') }} </a>
                                    </li>
                                @endcan

                                @can('view_culture')
                                    <li>
                                        <a href="{{ route('admin.portal.culturies') }}"> {{ __('Culture') }} </a>
                                    </li>
                                @endcan

                                @can('view_package')
                                    <li>
                                        <a href="{{ route('admin.portal.packages') }}"> {{ __('Packages') }} </a>
                                    </li>
                                @endcan

                                @can('view_package')
                                    <li>
                                        <a href="{{ route('admin.portal.rays_portal') }}"> {{ __('Rays') }} </a>
                                    </li>
                                @endcan
                    ...
                    @can('view_test')
                        <li class="menu">
                            ...
                            <ul class="collapse submenu list-unstyled" id="rays" data-parent="#accordionExample">
                                @can('view_category')
                                    <li>
                                        <a href="{{ route('admin.rays_categories.index') }}"> {{ __('Rays Categroies') }}
                                        </a>
                                    </li>
                                @endcan
                                @can('view_test')
                ...
                @can('view_hr')
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="hr" data-parent="#accordionExample">
                            ...
                            @can('view_hr')
                                <li>
                                    <a href="{{ route('admin.incentives.index') }}"> {{ __('incentives') }}</a>
                                </li>
                            @endcan

                            @can('view_hr')
                                <li>
                                    <a href="{{ route('admin.deductions.index') }}">{{ __('deductions') }}</a>
                                </li>
                            @endcan
                ...
                @if (isset($employee) && $employee != null)
                    @can('view_hr')
                        <li class="menu">
                            <a href="#salaryDetails" data-toggle="collapse" aria-expanded="true"
                                class="dropdown-toggle">
                                <div class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        version="1.1" id="Layer_1" x="0px" y="0px"
                            ...
                            <ul class="collapse submenu list-unstyled" id="salaryDetails"
                                data-parent="#accordionExample">



                                <li>
                                    <a href="{{ route('admin.salary-details') }}"> {{ __('Salary') }}</a>
                                </li>
                ...
                @canany(['view_payment_method', 'view_expense', 'view_expense_category'])
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="Accounting" data-parent="#accordionExample">
                            ...
                            @can('view_expense')
                                <li>
                                    <a href="{{ route('admin.expenses.index') }}"> {{ __('View Expenses') }}</a>
                                </li>
                            @endcan
                            @can('create_expense')
                                <li>
                                    <a href="{{ route('admin.expenses.create') }}"> {{ __('Expenses') }}</a>
                                </li>
                            @endcan
                ...
                {{-- Reporting --}}
                @canany(['view_accounting_report', 'view_doctor_report', 'view_supplier_report', 'view_contract_report',
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="Reporting" data-parent="#accordionExample">
                            ...
                            @can('view_accounting_report')
                                {{-- <li>
                                    <a href="{{ route('admin.reports.category_details') }}">
                                        {{ __('Category report') }}</a>
                                </li> --}}
                            @endcan
                            @can('accept_export_safe')
                                <li>
                                    <a href="{{ route('admin.reports.safe') }}">
                                        {{ __('Safe Transfer Report') }}</a>
                                </li>
                            @endcan
                ...
                @can('view_safe')
                    <li class="menu">
                        <a href="#safe" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512"
                                    style="enable-background:new 0 0 512 512;" xml:space="preserve">
                        ...
                        <ul class="collapse submenu list-unstyled" id="safe" data-parent="#accordionExample">

                            <li>
                                <a href="{{ route('admin.safe_transfer.index', ['type' => 'refused']) }}">
                                    {{ __('Rejected Transfers') }}</a>
                            </li>

                            @can('accept_export_safe')
                                <li>
                                    <a href="{{ route('admin.safe_transfer.index', ['type' => 'main']) }}">
                                        {{ __('Transfer to Owner') }}
                                    </a>
                                </li>
                            @endcan
                            @can('export_safe')
                                @if (session('branch_id') == setting('account')['branch'])
                                    <li>
                                        <a href="{{ route('admin.safe_transfer.index', ['type' => 'export']) }}">
                                            {{ __('Money Transfers') }}
                                        </a>
                                    </li>
                                @endif
                            ...
                            @can('all_safe')
                                <li>
                                    <a href="{{ route('admin.safe_transfer.index', ['type' => 'all']) }}">
                                        {{ __('All Transfers') }}
                                    </a>
                                </li>
                            @endcan
                ...
                @can(['view_setting'])
                    ...
                    <!-- notifications -->
                    <li class="menu">
                        <a href="#Notifications" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    version="1.1" id="Layer_1" x="0px" y="0px"
                                    ...
                                    <path style="fill:#CF933C;"
                                        d="M228.217,28.991c0,16.012,12.98,28.991,28.991,28.991V0C241.198,0,228.217,12.98,228.217,28.991z" />
                                    <circle style="fill:#940009;" cx="256.001" cy="445.979" r="66.024" />
                                    <path style="fill:#FF0029;"
                                        d="M189.977,445.976c0,36.464,29.56,66.024,66.024,66.024V379.951  C219.537,379.951,189.977,409.51,189.977,445.976z" />
                                    <path style="fill:#FF9800;"
                                        d="M466.898,401.879c-62.965-71.102-97.28-162.596-96.745-257.568c0.001-0.22,0.002-0.44,0.002-0.66  c0-63.325-51.335-114.66-114.66-114.66s-114.66,51.335-114.66,114.66c0,0.324,0.001,0.649,0.004,0.972  c0.786,94.597-33.258,186.213-95.729,257.253l-0.003,0.003L466.898,401.879L466.898,401.879z" />
                                    <path style="fill:#F7DC4D;"
                                        d="M256.001,28.998c-0.169,0-0.338-0.007-0.507-0.007c-63.325,0-114.66,51.336-114.66,114.66  c0,0.324,0.001,0.649,0.004,0.972c0.786,94.597-33.258,186.213-95.729,257.253l-0.003,0.003h210.895V28.998z" />
                                    <path style="fill:#E5BF2B;"
                                        d="M453.58,445.976H58.423c-16.546,0-29.96-13.414-29.96-29.96l0,0c0-16.546,13.414-29.96,29.96-29.96  H453.58c16.546,0,29.96,13.414,29.96,29.96l0,0C483.54,432.562,470.126,445.976,453.58,445.976z" />
                                    <path style="fill:#005A95;"
                                        d="M412.621,322.486c-12.92-25.161-22.999-51.667-30.1-79.04H128.771  c-7.012,27.356-16.997,53.868-29.81,79.04H412.621z" />
                                    <path style="fill:#31AAEF;"
                                        d="M256.001,243.446H128.982c-7.012,27.356-16.997,53.869-29.811,79.04h156.829V243.446z" />
                                    <path style="fill:#F9ED9D;"
                                        d="M256.001,386.056H58.423c-16.546,0-29.96,13.414-29.96,29.96l0,0c0,16.546,13.414,29.96,29.96,29.96  h197.579v-59.919H256.001z" />
                                </svg>
                        ...
                        <ul class="collapse submenu list-unstyled" id="Notifications" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="{{ route('admin.notifications.create') }}"> {{ __('Create Notifications') }}
                                </a>
                            </li>
                    ...
                    <!-- whatsapp -->
                    <li class="menu">
                        <a href="#whatsapp" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    version="1.1" id="Layer_1" x="0px" y="0px"
                                    viewBox="0 0 512.003 512.003" style="enable-background:new 0 0 512.003 512.003;"
                        ...
                        <ul class="collapse submenu list-unstyled" id="whatsapp" data-parent="#accordionExample">
                            <li>
                ...
                @can('view_translation')
                    <li class="menu">
                        ...
                        <a href="{{ route('admin.translations.index') }}" aria-expanded="true"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    version="1.1" id="Layer_1" x="0px" y="0px"
                    ...
                    <li class="menu">
                        ...
                        <a href="{{ route('admin.activity_logs.index') }}" aria-expanded="true"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    version="1.1" id="Layer_1" x="0px" y="0px"
                ...
                <li class="menu">
                    ...
                    <a href="{{ url('/') }}/clear-cache" aria-expanded="true" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                version="1.1" id="Layer_1" x="0px" y="0px"
                                viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
