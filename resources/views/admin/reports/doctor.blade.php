  ...
  <div class="content-wrapper">
              ...
              <div class="row">
                ...
                <div class="col-lg-2 col-sm-12 col-xs-12 mt-4 mb-4 custom-info-box">
                  <div class="row">
                    ...
                    <div class="col-7 col-sm-8 col-xs-8">
                      <h4 class="m-0">
                        {{formated_price($doctor_commission)}}
                      </h4>
                      <span>
                        {{__('Doctor Commission %')}}
                      </span>
                    </div>
                  </div>
                </div>
                <div class="col-lg-2 col-sm-12 col-xs-12 mt-4 mb-4 custom-info-box">
                  <div class="row">
                    ...
                    <div class="col-7 col-sm-8 col-xs-8">
                      <h4 class="m-0">
                        {{formated_price($doctor_total)}}
                      </h4>
                      <span>
                        {{__('Doctor Commission Total')}}
                      </span>
                    </div>
                  </div>
                </div>
      ...
      <div class="card-footer">
        <a href="{{request()->fullUrl()}}&pdf=true" class="btn btn-danger" target="_blank">
          <i class="fas fa-file-pdf"></i> {{__('Details PDF')}}
        </a>
      </div>
      <div class="card-footer">
        <a href="{{request()->fullUrl()}}&summary_pdf=true" class="btn btn-danger" target="_blank">
          <i class="fas fa-file-pdf"></i> {{__('Summary PDF')}}
        </a>
      </div>
    @endif
  </div>
