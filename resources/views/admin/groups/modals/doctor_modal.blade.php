                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                       <div class="input-group mb-3">
                           ...
                           <input type="text" class="form-control" placeholder="{{__('Doctor Name')}}" name="name" id="dector_name" required>
                       </div>
                      </div>
                   </div>
                   ...
                   <div class="col-lg-4">
                       <div class="form-group">
                           <div class="input-group mb-3">
                               ...
                               <input type="text" class="form-control" placeholder="{{__('Email Address')}}" name="email" id="email">
                           </div>
                       </div>
                   </div>
                     ...
                     <div class="form-group">
                         <div class="form-group">
                             <div class="input-group mb-3">
                                 ...
                                 <input type="password" class="form-control" placeholder="{{__('Password')}}" name="password" id="password" minlength="6" required>
                             </div>
                         </div>
                     </div>
                   </div>
