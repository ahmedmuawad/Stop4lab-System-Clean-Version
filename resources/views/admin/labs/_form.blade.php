...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group @if($errors->has('email')) error-validation @endif">
            ...
            <input type="text" class="form-control" name="email" placeholder="{{__('Email')}}" id="email"
...
<div class="row">
    <div class="col-lg-4">
        <div class="form-group">
            <label for="show_qr">{{ __('Show Qr Code') }}</label>
            <input type="checkbox" name="show_qr" id="show_qr"
                value="1" {{ !empty($lab) && $lab['show_qr'] == 1 ? 'checked' : '' }} class="form-control"
                >
        </div>
    </div>
    <div class="col-lg-4">
        <div class="form-group">
            <label for="show_contract_name">{{ __('Show Contract Name') }}</label>
            <input type="checkbox" name="show_contract_name" id="show_contract_name"
                value="1" {{ !empty($lab) && $lab['show_contract_name'] == 1 ? 'checked' : '' }} class="form-control"
                >
        </div>
    </div>
    <div class="col-lg-4">
        <div class="form-group">
            <label for="show_sample_collect">{{ __('Show Sample Collect') }}</label>
            <input type="checkbox" name="show_sample_collect" id="show_sample_collect"
                value="1" {{ !empty($lab) && $lab['show_sample_collect'] == 1 ? 'checked' : '' }} class="form-control"
                >
        </div>
    </div>
</div>
