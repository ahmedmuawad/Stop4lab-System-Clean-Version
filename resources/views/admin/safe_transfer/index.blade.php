    ...
    <div class="card-body">
       <div class="col-lg-12 table-responsive">
          <table id="safe_transfer_table" class="table table-striped table-bordered"  width="100%">
            <thead>
            <tr>
              @if ($type == "all" || $type == "main")<th width="10px"><input type="checkbox" class="check_all" name="" id=""></th>@endif
              <th width="10px">#</th>
...
@section('scripts')
  ...
  @elseif ($type == "main")
    <script src="{{url('js/admin/safe_transfer_main.js')}}"></script>
  @elseif ($type == "pending")
    <script src="{{url('js/admin/safe_transfer.js')}}"></script>
  @elseif ($type == "all")
    <script src="{{url('js/admin/safe_transfer_all.js')}}"></script>
  @elseif ($type == "export")
    <script src="{{url('js/admin/safe_transfer_export.js')}}"></script>
  @endif
@endsection
