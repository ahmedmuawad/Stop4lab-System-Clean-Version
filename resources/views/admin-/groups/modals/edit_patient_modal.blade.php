                    ...
                    <div class="row">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <select id="prefix" name="prefix" class="form-control" width="90%">
                                        ...
                                        @if (isset($group) && isset($group['patient']))
                                            <option value="{{ $group['patient']['prefix'] }}" selected>
                                                {{ $group['patient']['prefix'] }}</option>
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ __('National ID') }}"
                                        name="national_id" id="edit_national_id">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ __('Passport no') }}"
                                        name="passport_no" id="edit_passport_no">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="{{ __('Phone number') }}" name="phone" id="edit_phone">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="{{ __('Phone number') }} 2" name="phone2" id="edit_phone2">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="gender"
                                            placeholder="{{ __('Gender') }}" id="edit_gender" required
                                            id="edit_gender">
                                            <option value="" disabled selected>{{ __('Select Gender') }}
                                            </option>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" class="form-control"
                                            placeholder="{{ __('Date of birth') }}" name="dob" id="edit_dob"
                                            required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-xs-6 col-md-6 pr-0">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" class="form-control" name="age" id="edit_age2"
                                            placeholder="{{ __('Age') }}" required>
                                        <span class="required"
                                            style="
                                                    font-size: 21px;
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-6 col-md-6 pl-0">
                                    <div class="input-group mb-3">
                                        <select class="form-control" name="age_unit" id="edit_age_unit2" required>
                                            <option value="" disabled selected>{{ __('Select age unit') }}
                                            </option>
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control datepicker"
                                        placeholder="{{ __('Date of PMS') }}" name="date_pms" id="edit_date_pms">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input check_ask" name="fluid_patient"
                                            id="edit_fluid_patient" type="checkbox" value=""
                                            id="flexCheckDefault">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input check_ask" name="diabetic" id="edit_diabetic"
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input check_ask" name="gland" id="edit_gland"
                                            type="checkbox" value="" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            {{ __('gland') }}
                                        </label>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input check_ask" name="tumors" id="edit_tumors"
                                            type="checkbox" value="" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            {{ __('tumors') }}
                                        </label>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input check_ask" name="antibiotic"
                                            id="edit_antibiotic" type="checkbox" value=""
                                            id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            {{ __('antibiotic') }}
                                        </label>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input check_ask" name="iron" id="edit_iron"
                                            type="checkbox" value="" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            {{ __('iron') }}
                                        </label>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input check_ask" name="cortisone"
                                            id="edit_cortisone" type="checkbox" value=""
                                            id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            {{ __('cortisone') }}
                                        </label>
                                ...
                                <div class="input-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input check_ask" name="pressure" type="checkbox"
                                            value="" id="edit_pressure">
                                        <label class="form-check-label" for="edit_pressure">
                                            {{ __('pressure') }}
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input check_ask" name="liver_patient"
                                            id="edit_liver_patient" type="checkbox" value=""
                                            id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            {{ __('Liver Patient') }}
                                        </label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="form-floating">
                                    <textarea class="form-control" name="answer_other" placeholder="{{ __('Other') }}" id="edit_answer_other"
