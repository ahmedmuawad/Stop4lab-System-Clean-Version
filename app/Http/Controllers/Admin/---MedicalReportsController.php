...
class MedicalReportsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if ($request['type'] == 'done') {
                ...
                $model->whereHas('all_tests',function($q){$q->where('sample_status','1');})->orWhereHas('all_cultures',function($q){$q->where('sample_status','1');});
    ...
    public function pdf(Request $request, $id)
    {
        ...
        $categories = $this->prePrintPdfWithRequest($group,$request);
    ...
    public function print_show_report($id)
    {
        ...
        // if ($group['uploaded_report']) {
        //     return wredirect($group['report_pdf']);
        // }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json([   'success'=>'Test result saved successfully' ,
                                    "current" => $id ,
                                    "next" =>$next,
                                    "warning" =>$string,
                                 ]);
    ...
    public static function prePrintPdf($group)
    {
        $categories = Category::get();
    ...
    public static function prePrintPdfWithRequest($group,$request)
    {
        $categories = Category::get();
