    ...
    */
    ...
    public function update(LabRequest $request, $id)
    {
       ...
       $lab->update([
           ...
           'show_contract_name' => $request->has('show_contract_name') ? 1 : 0,
           'show_sample_collect' => $request->has('show_sample_collect')  ? 1 : 0,
           'show_qr' => $request->has('show_qr')  ? 1 : 0,
       ]);


       $role = Role::firstOrCreate(['name' => 'lab']);
    ...
    public function store(LabRequest $request)
    {
        $lab = User::create([
            ...
            'region_id'          => $request['region_id'],
            'type'               => 'lab',
            'show_contract_name' => isset($request['show_contract_name']) ? 1 : 0,
            'show_sample_collect' => isset($request['show_sample_collect']) ? 1 : 0,
            'show_qr' => isset($request['is_out']) ? 1 : 0,
        ]);
