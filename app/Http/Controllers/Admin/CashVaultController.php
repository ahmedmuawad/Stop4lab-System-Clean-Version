...
class CashVaultController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->type == 0){
            ...
            if($vault){
                ...
                session()->flash('failed',__("User Not  Recipt Cache in This Branch , You Shoud Recipt With This Account In This Branch "));
    ...
    public function custody(Request $request)
    {
        ...
        $custody->custody_type = $request->custody_type;
    ...
    public function bulk_delete(BulkActionRequest $request)
    {
        ...
        {
            $vault = Cash_in_vault::find($id);

            ($vault->payments()->count())? $vault->payments()->delete() : null;
