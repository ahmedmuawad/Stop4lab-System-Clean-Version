...
*/
    ...
    */
    ...
    var table = $('#tests_table_new_design').DataTable( {
        ...
        "ajax": {
            url: url("new-design/admin/get_tests")
        },
        columns: [
            { data: "bulk_checkbox", searchable: false, sortable: false, orderable: false },
            { data: "id", sortable: true, orderable: true },
            { data: "category.name", sortable: false, orderable: true },
            { data: "name", sortable: true, orderable: true },
            { data: "shortcut", sortable: false, orderable: true },
            { data: "sample_type", sortable: false, orderable: true },
            { data: "price", sortable: false, orderable: true },
