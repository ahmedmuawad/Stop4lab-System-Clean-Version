    ...
    table=$('#expenses_table').DataTable( {
      ...
      "order": [
        ...
        "columns": [
           ...
           {data:"doctor.name",searchable:true,orderable:true,sortable:true},
           {data:"source",searchable:true,orderable:true,sortable:true},
           {data:"created_at",searchable:true,orderable:true,sortable:true},
           {data:"custody.custody",searchable:false,orderable:false,sortable:false},
