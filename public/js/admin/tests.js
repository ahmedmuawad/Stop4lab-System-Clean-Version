...
(function ($) {
  ...
  table = $('#tests_table').DataTable({
    ...
    "columns": [
      ...
      // { data: "category.parent.name",searchable: false, sortable: false, orderable: false },
  ...
  $('.add_component').on('click', function () {
    ...
    $('.components .items').append(`
            <tr id="component_` + count + `" num="` + count + `">
               ...
               <td> 
               <div class="form-group">
               <input type="text" class="form-control" placeholder="defult value" name="component[`+ count + `][default]" 
  ...
  $(document).on('change', '.select_type', function () {
    ...
    var html = `
     <table width="600">
        ...
        <tbody>
          <tr>
            <td>
              <input type="text" name="component[` + component_num + `][options][` + option_count + `][name]" class="form-control" required>
            </td>
            <td>
              <select class="form-control"
                name="component[` + component_num + `][options][` + option_count + `][gender]"
                required>
                <option value="both">
                Both</option>
                <option value="male">
            ...
            <td>
              <select class="form-control" name="component[` + component_num + `][options][` + option_count + `][status]" id="">
                  <option></option>
    ...
    <table width="600">
       <thead>
          <tr>
            <th>` + trans('Option') + ` * </th>
            <th width="10px">
             <button type="button" class="btn btn-primary btn-sm add_one_option">
               <i class="fa fa-plus"></i>
             </button>
            </th>
          </tr>
       ...
       <tbody>
         <tr>
           <td>
             <input type="text" name="component[` + component_num + `][options][` + option_count + `][name]" class="form-control" required>
             <input type="hidden" name="component[` + component_num + `][options][` + option_count + `][status]" class="form-control" required>
             <input type="hidden" name="component[` + component_num + `][options][` + option_count + `][gender]" class="form-control" required>
           </td>
           <td>
             <button type="button" class="btn btn-danger btn-sm delete_option">
               <i class="fa fa-trash"></i>
    ...
    <table width="600">
       ...
       <tbody>
         <tr>
          <td>
            <input type="text" name="component[` + component_num + `][options_additional][` + option_count + `][name]" class="form-control" required>
          </td>
          <td>
              <select class="form-control"
                name="component[` + component_num + `][options_additional][` + option_count + `][gender]"
                required>
                <option value="both">
                Both</option>
                <option value="male">
          ...
          <td>
              <select class="form-control" name="component[` + component_num + `][options_additional][` + option_count + `][status]" id="">
                  <option></option>
                  <option  value="Abnormal">Abnormal</option>
                  <option  value="Normal">Normal</option>
                  <option  value="Panic">Panic</option>
   ...
   `;
    if (type == 'select') {
      ...
      $(this).closest('tr').find('.reference_range').remove();
    } else if (type == 'multy') {
    ...
    var html = `<tr>
                ...
                <td>
                  <select class="form-control" name="component[` + component_num + `][options][` + option_count + `][status]" id="">
                      ...
                      <option  value="Abnormal">Abnormal</option>
                      <option value="Normal">Normal</option>
                      <option value="Normal">Panic</option>
                  </select>
                </td>
  ...
  $(document).on('click', '.add_one_option', function () {
    option_count++;
    var component_num = $(this).parent().parent().parent().parent().parent().parent().parent().attr('num');
    var html = `<tr>
                <td>
  ...
  $(document).on('click', '.add_range', function () {
    ...
    <tr>
        ...
        <td colspan="2">
          <label for=""> `+ trans('Show') + `</label>
          <input name="component[${component_num}][reference_ranges][${count_reference_ranges}][show_status]" type="checkbox" value="1" />
        </td>
    </tr>
    `);
  });
  ...
  $(document).on('click', '.add_comment', function () {
    ...
    $('#comments_table tbody').append(`
      <tr>
          <td>
            <div class="form-group">
                <textarea  name="comments[`+ count_comments + `]" class="form-control ray_comment" id="" cols="30" rows="3" required></textarea>
            </div>
          </td>
          <td>
              <button type="button" class="btn btn-danger btn-sm delete_comment">
  ...
  $(document).on('click', '.add_question', function () {
    ...
    $('#questions_table tbody').append(`
      <tr>
          <td>
            <div class="form-group">
                <textarea name="questions[`+ question_count + `]" class="form-control" id="" cols="30" rows="3" required></textarea>
            </div>
          </td>
          <td>
