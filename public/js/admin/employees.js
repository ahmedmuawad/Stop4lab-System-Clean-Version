    ...
    table=$('#reports_table').DataTable( {
        ...
        "bSort" : true,
          ...
          "columns": [
            ...
            {data:"certificate_allowance" ,name:"certificate_allowance"},
            {data:"Management_commitment" ,name:"Management_commitment"},

            
            // certificate_allowance
            
            // {data:"base_salary"  , sortable:false,orderable:false},
