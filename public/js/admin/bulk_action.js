    ...
    if(table!==undefined&&table!=='')
    {
        ...
        table.on('init',function(){
            ...
            if(action=='groups')
            {
                ...
                addition_actions=`
                    <a href="`+url('admin')+`/test" class="bulk_button dropdown-item" warning_message="`+trans('Are you sure to Code bulk Tests ?')+`">
                        <i class="fa fa-barcode"></i>
                        `+trans('Code Tests')+`
                    </a>`;
            }
                ...
                addition_actions=`
                    <a href="`+url('admin')+`/culture" class="bulk_button dropdown-item" warning_message="`+trans('Are you sure to Code bulk Cultures ?')+`">
                        <i class="fa fa-barcode"></i>
                        `+trans('Code Cultures')+`
                    </a>`;
            }
                ...
                addition_actions=`
                    <a href="`+url('admin')+`/package" class="bulk_button dropdown-item" warning_message="`+trans('Are you sure to Code bulk packages ?')+`">
                        <i class="fa fa-barcode"></i>
                        `+trans('Code Packages')+`
                    </a>`;
            }
                ...
                addition_actions=`
                    <a href="`+url('admin')+`/rays_portal" class="bulk_button dropdown-item" warning_message="`+trans('Are you sure to Code bulk rays ?')+`">
                        <i class="fa fa-barcode"></i>
                        `+trans('Code rays')+`
                    </a>`;
            }
            ...
            {
                console.log(action)
                if(action == "safe_transfer?type=all"){
                    delete_action=`
                    <a href="`+url('admin/safe_transfer')+`/bulk/delete" class="bulk_button dropdown-item text-danger" id="delete_bulk" warning_message="`+trans('Are you sure to delete bulk ?')+`">
                        <i class="fa fa-trash"></i>
                        `+trans('Delete')+`
                    </a>
                    `;
                }else if(action == "safe_transfer?type=main"){
                    delete_action=`
                    <a href="`+url('admin/safe_transfer')+`/accept_all" class="bulk_button dropdown-item text-success" id="delete_bulk" warning_message="`+trans('Are you sure to Accept All ?')+`">
                        <i class="fa fa-trash"></i>
                        `+trans('Accept All')+`
                    </a>
                    `;
                ...
                <div class="row" id="bulk_action_section">
                        <div class="col-lg-12">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="left: 1257 px !important;">
