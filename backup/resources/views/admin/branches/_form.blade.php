            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="basic-addon1">
                    ...
                    {{-- <i class="nav-icon fas fa-money-from-bracket"></i> --}}
                    {{-- <i class="fa-solid fa-money-from-bracket"></i> --}}
                  </span>
                </div>
                <input type="number" class="form-control" placeholder="{{__('Custody')}}" name="custody" id="custody" @if(isset($branch)) value="{{$branch->custody}}" @endif>
            </div>
        </div>
    </div>
    <div class="col-lg-3">
        <div class="form-group">
            <div class="input-group mb-3">
                ...
                <select name="ray_status" class="form-control">
                    <option value="0" >{{ __('Presonal') }}</option>
                    <option value="1" >{{ __('From Lab') }}</option>
                </select>            
            </div>
        </div>
    </div>
