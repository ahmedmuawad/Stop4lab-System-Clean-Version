        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
              <div class="nav flex-column nav-tabs  h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link"  data-toggle="pill" href="#medical_settings" role="tab" aria-controls="medical_settings" aria-selected="true"><i class="fas fa-book-medical"></i> {{__('Medical')}}</a>
                @if(isset($printer_settings) && $printer_settings != null )
                  <a class="nav-link"  data-toggle="pill" href="#printer_settings" role="tab" aria-controls="printer_settings" aria-selected="true"><i class="fas fa-print"></i> {{__('Printer')}}</a>
                @endif
...
{{--
                ...
                <!-- printer Settings -->
                @if(isset($printer_settings) && $printer_settings != null )
                  <div class="tab-pane text-left fade show" id="printer_settings" role="tabpanel" aria-labelledby="printer_settings">
                        <div class="card card-primary">
                            <div class="card-header">
                            ...
                            <form action="{{route('admin.settings.printer_submit')}}" method="POST">
                              ...
                              <div class="card-body">
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        <label for="barcode_settings_type">{{__('Working Paper')}}</label>
                                        <input type="text" name="working_paper" id="working_paper" class="form-control" value="{{$printer_settings['working_paper']}}"  required >
                                        {{--  --}}
                                      </div>
                                    </div>
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="parcode" id="parcode" class="form-control" value="{{$printer_settings['parcode']}}" required>
                                        {{--  --}}
                                      </div>
                                    </div>
                                  </div>
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="receipt" id="receipt" class="form-control" value="{{$printer_settings['receipt']}}" required>
                                        {{--   --}}
                                      </div>
                                    </div>
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="report" id="report" class="form-control"  value="{{$printer_settings['report']}}"  required>
                                        {{--  --}}
                                      </div>
                                    </div>
                                  </div>
