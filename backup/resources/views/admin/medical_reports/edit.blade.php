                                                                                                    ...
                                                                                                    foreach ($result['component']->reference_ranges as $ref_range) {
                                                                                                        ...
                                                                                                        if (($ref_range->gender == $group->patient->gender or $ref_range->gender == 'both') && (int) $group->patient->age <= $ref_range->age_to_days / 365 && (int) $group->patient->age >= $ref_range->age_from_days / 365) {
                                                                                                            if($ref_range->comment == null){
                                                                                                                ...
                                                                                                                if($ref_range->normal_from == null || $ref_range->normal_to == null ){
                                                                                                                    $comment = $comment = $ref_range->comment;
                                                                                                                    
                                                                                                                }else {
                                                                                                                    $comment = $ref_range->normal_from . ' &nbsp; : &nbsp; ' . $ref_range->normal_to . '<br>' . $comment = $ref_range->comment ;   
                                                                                        ...
                                                                                        @if ($result['component']['type'] == 'text')
                                                                                            ...
                                                                                            <input type="text"
                                                                                                ...
                                                                                                name="result[{{ $result['id'] }}][result]"
                                                                                                 class="{{ $result['component']['id'] == 1257 ? 'WBCs' : '' }} {{ $result['component']['id'] == 1261 ? 'Lymphocytes' : '' }} {{ $result['component']['id'] == 1262 ? 'Monocytes' : '' }} {{ $result['component']['id'] == 1263 ? 'Eosinophils' : '' }} {{ $result['component']['id'] == 1264 ? 'Basophils' : '' }} {{ $result['component']['id'] == 1266 ? 'Neutrophil' : '' }} {{ $result['component']['id'] == 1267 ? 'Segment' : '' }} {{ $result['component']['id'] == 1268 ? 'Band' : '' }} form-control  {{ $result['component']['id'] == 1419 ? 'a_Lymphocytes' : '' }} {{ $result['component']['id'] == 1420 ? 'a_Monocytes' : '' }} {{ $result['component']['id'] == 1421 ? 'a_Eosinophils' : '' }} {{ $result['component']['id'] == 1422 ? 'a_Basophils' : '' }} {{ $result['component']['id'] == 1424 ? 'a_Neutrophil' : '' }} {{ $result['component']['id'] == 1425 ? 'a_Segment' : '' }} {{ $result['component']['id'] == 1426 ? 'a_Band' : '' }} test_result {{ $result['component']['id'] == 1249 ? 'rpcs' : '' }} {{ $result['component']['id'] == 1253 ? 'mchc' : '' }} {{ $result['component']['id'] == 1251 ? 'mcv' : '' }} {{ $result['component']['id'] == 1248 ? 'Hemoglobin' : '' }} {{ $result['component']['id'] == 1252 ? 'mch' : '' }} {{ $result['component']['id'] == 1250 ? 'hct' : '' }} {{ $result['component']['id'] == 1483 ? 'cho' : '' }} {{ $result['component']['id'] == 1484 ? 'Triglycerides' : '' }} {{ $result['component']['id'] == 1485 ? 'hdl' : '' }} {{ $result['component']['id'] == 1486 ? 'ldl' : '' }} {{ $result['component']['id'] == 1487 ? 'Risk1' : '' }} {{ $result['component']['id'] == 1488 ? 'Risk2' : '' }} {{ $result['component']['id'] == 532 ? 'pt' : '' }} {{ $result['component']['id'] == 1479 ? 'Concentration' : '' }} {{ $result['component']['id'] == 1853 ? 'PT_Time' : '' }} {{ $result['component']['id'] == 1854 ? 'Control_Time' : '' }} {{ $result['component']['id'] == 1855 ? 'Activity' : '' }} {{ $result['component']['id'] == 1856 ? 'INR' : '' }}"
                                                                                                data-component="{{ $result['component']['id'] }}"
                                                                                                data-url="{{ route('admin.medical_report.get-comment') }}"
                                                                                                @if ($result['component']['id'] == 1854) value="{{ $medical_settings['pt_control_time'] }}" readonly @else value="{{ $result['result'] }}" @endif
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="5">
                                                                            ...
                                                                            <textarea name="comment" cols="30" rows="3" placeholder="{{ __('Comment') }}"
                                                                                class="form-control ray_comment">{{ $test['comment'] }}</textarea>
                                                                                    ...
                                                                                    <td>
                                                                                       ...
                                                                                       @elseif ($result['component']['type'] == 'multy')
                                                                                            ...
                                                                                            <textarea  
                                                                                                ...
                                                                                                class="form-control resulte_option " >
                                                                                                {{ $result['result'] }}
                                                                                            </textarea> 
